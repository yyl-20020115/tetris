...
public class Controls extends Component {
    ...
    public Controls(GameActivity ga) {
        ...
        initialHIntervalFactor = PreferenceManager.getDefaultSharedPreferences(host).getBoolean("pref_accelerationH", true) ? 2 : 1;
        initialVIntervalFactor = PreferenceManager.getDefaultSharedPreferences(host).getBoolean("pref_accelerationV", true) ? 2 : 1;
